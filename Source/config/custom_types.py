...
def _type_call_roblox_version(config: base_type, typ: type, path: str, val) -> util.versions.roblox:
    return util.versions.roblox.from_name(val)
...
type_calls = {
    Callable:
        _type_call_callable,
    util.versions.roblox:
        _type_call_roblox_version,
    Union:
        _type_call_union,
    file_path:
